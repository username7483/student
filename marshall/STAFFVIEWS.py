...
from .models import CustomUser, Teacher,  Students, SessionYearModel, Attendance, AttendanceReport, StudentResult
...
def main2(request):
	if request.method=='POST':
		return render(request, 'teacher templates\main2.html')
	else:
		return render(request, 'teacher templates\main2.html')
...
def staff_take_attendance(request):
	...
	return render(request, "teacher templates/take_attendance_template.html", context)
...
def staff_update_attendance(request):
	...
	return render(request, "teacher templates/staff_update_attendance.html", context)
...
def staff_profile(request):
	...
	return render(request, 'teacher templates/staff_profile.html', context)
...
def staff_add_result(request):
	...
	return render(request, "teacher templates/staff_add_result.html", context)
